    ...
    <div className="flex-1 flex flex-col items-center justify-center px-4">
      <div className="max-w-2xl w-full flex flex-col items-center">
        ...
        <div className="mb-8 text-center">
          <div className="w-16 h-16 rounded-2xl bg-honey-500/15 flex items-center justify-center mx-auto mb-4 glow-honey">
        ...
        <div className="flex gap-2 flex-wrap justify-center">
          {quickActions.map(({ icon: Icon, label, color }) => (
            <button
              key={label}
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-hive-surface border border-hive-border hover:border-honey-500/30 hover:bg-hive-elevated transition-all text-sm text-text-secondary hover:text-text-primary"
            >
        ...
        <div className="mt-10 grid grid-cols-3 gap-3 w-full max-w-lg">
          {[
            ...
            <div key={title} className="p-4 rounded-xl bg-hive-surface border border-hive-border hover:border-honey-500/20 cursor-pointer transition-all group">
              <div className="text-2xl mb-2">{icon}</div>
              <div className="text-sm font-medium text-text-primary group-hover:text-honey-500 transition-colors">{title}</div>
